...
with open('03_temperatura_ansys_2grau.txt') as f_input:
...
# considerou-se del_x, del_y e del_z constantes ao longo das suas respectivas direções.
A_x = 1 / del_x**2
A_y = 1 / del_y**2
A_z = 1 / del_z**2
A_p = 2 * (A_x + A_y + A_z)
...
df.to_csv("03_parametros_estimados_2grau.txt", sep='\t')
